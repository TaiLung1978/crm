...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-success fixed-top">
        <a class="navbar-brand" href="https://www.lopez.one">CRM By Lopez.one</a>
        ...
        <div class="collapse navbar-collapse" id="miNavbar">
            ...
            <ul class="navbar-nav">
                <li class="nav-item active">
                    <a class="nav-link" href="https://www.lopez.one"><span class="mdi mdi-handshake-outline"></span>Ayuda y soporte</a>
                </li>
            </ul>
        </div>
    </nav>
